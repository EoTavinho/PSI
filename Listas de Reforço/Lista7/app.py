    ...
    if request.method == 'POST':
        ...
        for usuario in usuarios_registrados:
            if usuario['username'] == username and usuario['password'] == password:
                ...
                session['funcao'] = usuario['funcao']  # Armazenar a função na sessão
...
def cadastro():
    if request.method == 'POST':
        ...
        funcao = request.form.get('funcao', 'usuário')  # Campo opcional, padrão é 'usuário'
        ...
        usuarios_registrados.append({
            ...
            'password': password,
            'nome': nome,
            'funcao': funcao  # Certifique-se de adicionar a chave 'funcao'
        })
...
def listar_usuarios():
    ...
    # Passar a lista filtrada para o template
